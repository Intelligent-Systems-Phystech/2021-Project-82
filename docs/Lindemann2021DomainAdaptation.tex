...
Сперва выборка отзывов с сайта Amazon приводтся к признаковому описанию tf-idf вектора. Далее с помощью EM-алгоритма модель обучается в течение 15 эпох. График зависимости точности классификации на тестовом наборе данных в зависимости от номера эпохи обучения представлен на рис.~\ref{example:2}.

\begin{figure}[H]\center
\includegraphics[width=0.8\textwidth]{Graph_1.pdf}
\caption{Зависимость точности классификации в зависимости от номера эпохи.}
\label{example:2}
\end{figure}
